                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" method="POST" action="{{url('/admin/edit-product/'.$productDetails->id)}}" novalidate="novalidate" name="edit_product" id="edit_product" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="description" rows="8" cols="80">{{$productDetails->description}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="care" id="care" rows="8" cols="80">
                                            {{$productDetails->care}}
                                        </textarea>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        @if(!empty($productDetails->image))
                                            <br>
                                            <img src="{{ asset('/images/backend_images/products/small/'.$productDetails->image) }}" style="width: 100px;">
                                            <br>
