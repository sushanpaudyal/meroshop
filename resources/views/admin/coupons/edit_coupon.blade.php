...
@section('content')
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Coupons</a> <a href="#" class="current">Edit Coupons</a> </div>
            <h1>Products</h1>
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" method="POST" action="{{url('/admin/edit-coupon', $couponDetails->id)}}"  name="edit_coupon" id="edit_coupon">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="coupon_code" id="coupon_code" minlength="5" maxlength="15" required value="{{$couponDetails->coupon_code}}">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="number" name="amount" id="amount" required min="1" value="{{$couponDetails->amount}}">
                                    </div>
                                </div>
