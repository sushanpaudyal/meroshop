                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" method="POST" action="{{url('/admin/edit-category/'.$categoryDetails->id)}}" novalidate="novalidate" name="add_category" id="add_category">
                                {{ csrf_field() }}
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="description" rows="8" cols="80">{{$categoryDetails->description}}</textarea>
                                    </div>
                                </div>
